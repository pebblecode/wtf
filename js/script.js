...
App.switchWords = function() {
  var wordListIndex = $("#categories .active").prev().length;
  switch(wordListIndex) {
  case 0: // Cities
    App.gameState.words = App.cityWords;
    break;
  case 1: // Movies
    App.gameState.words = App.movieWords;
    break;
  }
};
